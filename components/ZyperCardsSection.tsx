...
const zyperCards = [
  {
    ...
    description:
      "Own exclusive digital dolphin collectibles in our unique NFT collection.",
    link: "/nftcollection",
  },
  {
    icon: CreditCard,
    ...
    description:
      "Experience seamless crypto payments with our next-gen digital payment card.",
    link: "/zypercard",
  },
  {
    icon: Gamepad2,
    ...
    description:
      "Dive into an exciting P2E gaming experience with Dolphin Dash.",
    link: "/dolphindash",
  },
  {
    icon: LockKeyhole,
    title: "NFT Staking",
    description:
      "Stake your NFTs to earn rewards in the Zyper ecosystem. Live Now!",
    status: "Live",
    link: "/nftcollection",
  },
  {
    ...
    description:
      "Connect to high-speed internet through our Starlink partnership.",
    comingSoon: true,
    link: "/",
  },
  {
          ...
          {zyperCards.map((card, index) => (
            <Link key={card.title} href={card.link} passHref>
              <motion.div
                ...
                className="cursor-pointer bg-gray-800/50 backdrop-blur-sm border border-blue-500/20 rounded-2xl p-8 text-center hover:border-blue-400/50 transition-all duration-300 relative"
              >
                {card.status === "Live" && (
